...
Nothing Phone 3 (NothingOS 3.0) users with a rooted device and Xposed should follow the standard setup. The Magisk patching module now supports Qualcomm QTI Bluetooth libraries used on Nothing Phone 3.
